package com.acumen.display
{
	...
	public class TitleListItem extends DatabaseListItem
	{
		public static const TYPE:String='Title';
		
		protected var addSelected:ContextMenuItem;
		protected var list:LibraryList;
		
		public function TitleListItem(socket:MpdSocket,parent:LibraryList = null,x:Number=0,y:Number=0,s:String='',i:*=null):void
		{
