package com.acumen.display
{
	...
	public class AlbumListItem extends DatabaseListItem
	{
		public static const TYPE:String='Album';
		
		public function AlbumListItem(socket:MpdSocket,parent:DisplayObjectContainer = null,x:Number=0,y:Number=0,s:String='',i:*=null):void
		{
